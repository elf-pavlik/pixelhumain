    ...
    <div class="container">
        ...
        <div class="navbar-header pull-left">
            ...
            <a href="<?php echo Yii::app()->createUrl('/survey/co/index/id/cte/session/'.$session); ?>" class="btn btn-link menu-btn-back-category pull-left no-padding" >
                <img src="https://pbs.twimg.com/profile_images/979647301332471808/4IxbxvoL_400x400.jpg" class="logo-menutop pull-left" height=35 style="vertical-align: middle"/> <span style="display:block" class="padding-15 hidden-xs">
                CONTRAT DE TRANSITION ÉCOLOGIQUE</span>
            </a>
