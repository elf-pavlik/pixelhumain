							...
							<?php
								foreach ($params as $key => $value) {
									...
									if($c > 0){
										...
										echo ' : <a href="'.$urlRedirect.$value["url"].'" style="color: #e33551;font-family: Helvetica, Arial, sans-serif;font-weight: normal;padding: 0;margin: 0;text-align: left;line-height: 1.3;text-decoration: none;">'.$value["name"]."</a></br></br>" ;
										echo "<span style='padding : 15px'>" ;
										foreach ($value["results"] as $keyR => $valueR) {
											echo "<span style='color: #2bb0c6; font-weight:bold;'><a href='".$urlRedirect."#page.type.classifieds.id.".$keyR."' style='color: #2bb0c6; font-weight:bold;' target='_blank' >".$valueR["name"]."</a></span> : ";
