<?php
	...
	return array(
		...
		"Create a classified ad<br>Sell or rent stuffs<br>Material, Property, Goods"=>"Publier une petite annonce<br>À Vendre ou à louer<br>Matériel, immobilier, affaires",
		"Make your need or your ressources visible<br>Material, competences, skills<br>And exchange it"=>"Partager ou demander des ressources<br>Matérielles, compétences, vos savoirs<br>Et échangez-les",
		"Add internship,<br>training and job offers<br>to make it territorialy visibe"=>"Ajouter une offre d'emploi,<br>un stage ou une formation<br>et partager les sur votre territoire",
