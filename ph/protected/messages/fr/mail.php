<?php
	return array(
		...
		"Answer to the invitation" => "R&eacute;pondre à l'invitation",
		//FOLLOW
		"You have a new follower" => "Vous avez un·e nouvel·le abonn&eacute;·e",
		"New follower" => "Nouvel·le abonn&eacute;·e",
		"All my followers" => "Tous mes abonn&eacute;s",
		//COMMON [FOOTER]
		...
		"Please connect you and go to the detail of {what} following link under to answer to the invitation"=>"Veuillez vous connecter et vous rendre sur la fiche d&eacute;tail de {what} en suivant le lien ci-dessous pour r&eacute;pondre à l&apos;invitation",
		...
		"Your password has been reset in response to your request"=>"Votre mot de passe a &eacute;t&eacute; r&eacute;initialis&eacute; suite à votre demande",
		"To connect you, you can use this password now"=>"Pour vous connecter, vous pouvez d&eacute;sormais utiliser ce mot de passe",
		...
		"All followers on {what}" => "Tous les abonn&eacute;s sur {what}",
		//Invitation
		...
		"For more details on the user {who}, you can visit {what}"=>"Pour plus de d&eacute;tails sur l&apos;utilisateur {who}, vous pouvez visiter {what}",
