...
return array(
	...
	"Report an abuse" => "Signaler un abus",
	...
	"You already declare this content as abused."=>"Vous avez déjà déclarer ce contenu comme abusif",
	...
	//Confirm
	"Are you sure you want to delete this news" => "Etes-vous sûr-e de vouloir supprimer cette publication ?",
	"Are you sure you want to delete this contact" => "Etes-vous sûr-e de vouloir supprimer ce contact ?",
	"Are you sure you want to delete this link" => "Etes-vous sûr-e de vouloir supprimer ce lien ?",
	...
	"Are you sure you want to delete this selection" => "Etes-vous sûr de supprimer cette sélection ?",
	"from your community" => "de votre communauté",
	"Are you sure you want to remove this connection" => "Etes-vous sûr d'annuler cette connexion",
	"Are you sure to not participate to this event" => "Etes-vous sûr de ne pas participer à cet événement",
	"Are you sure to leave this event"=>"Etes-vous sûr de quitter cet événement",
	"Are you sure to remove the link with this organization" => "Etes-vous sûr d'annuler le lien avec cette organisation",
	"Are you sure to remove the link with this project" => "Etes-vous sûr d'annuler le lien avec ce projet",
	"Are you sure to remove the link of member" => "Etes-vous sûr d'annuler ce lien de membre",
	"Are you sure to remove this follow"=> "Etes-vous sûr de vous désabonner",
	...
	"Are you sure to confirm the help from" => "Etes vous sûre de confirmer l'aide de",
	"Are you sure you want to help for this need" => "Etes-vous sûre de confirmer votre aide ur le besoin",
	//Indication
	"When" => "Quand",
	"Where" => "Où",
	"From" => "De",
	...
	"Are you sure to delete this folder"=>"Etes vous sur de supprimer le dossier",
	...
	"Are you sure you want to confirm" => "Etes-vous sûr de confirmer",
...
merci de renseigner votre code postal dans l'adresse de votre profil.",
	...
	"Only community can access to this page and see its informations."=>"Seul la communauté peut voir cette page et y accéder.",
	"Max price"=>"Prix max",
	"Min price"=>"Prix min",
	"Currency"=>"Devise",
	...
	"For which reason do you report this content"=>"Pour quelle raison signalez-vous ce contenu",
	"Evil tongues"=>"Propos malveillants",
	"Incitement and glorification of agressive driving"=>"Incitation et glorification des conduites agressives",
	"Display of gory and trash content"=>"Affichage de contenu gore et trash",
	"Pornographic content"=>"Contenu pornographique",
	"Deceptive or deceitful links"=>"Liens fallacieux ou frauduleux",
	"Copyright infringement"=>"Violations des droits d&#146;auteur",
	"All reporting is definitive and you can&#146;t cancel it"=>"Tout signalement est définitif, vous ne pourrez pas l&#146;annuler",
	"Your reporting will be sent to the system's administrators, <br/> who will deal with it according to the"=>"Votre signalement sera envoyé aux administrateurs du réseau,<br> qui le traiteront conformément aux",
	"general terms of use"=>"conditions générales d&#146;utilisations",
	...
	"Hello, you have made a request to know what data we have, you find attached the data and if below a summary" => "Bonjour, vous avez fait une demande pour savoir quelles données nous disposons, vous trouvez en pièce-joint les données et si dessous un résumé",
