...
merci de renseigner votre code postal dans l'adresse de votre profil.",
	...
	"Please enter a valid URL (ex: http://wwww.communecter.org)" => "Veuillez entrer une url valide (ex: http://wwww.communecter.org)",
	...
	"{what} published by {who}"=>"{what} publié par {who}",
	"{what} published by"=>"{what} publié par",
);
?>
